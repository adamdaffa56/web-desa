...
const UpdateUMKM = () =>{
    return(
        <section id="Informasi" className={'w-screen bg-[url(http://localhost:3000/background-hijau.png)] bg-cover bg-center flex flex-col p-[32px]'}>
            ...
            <h2 className="font-semibold text-[35px] text-cream font-poppins flex justify-start mb-[40px]">Update UMKM</h2>
            ...
            <div className=" flex flex-col justify-start items-start text-start font-poppins font-normal text-[20px] text-cream">
                <form action="" method="">
                    ...
                    <div className='flex flex-row gap-[20px]'>
                        <input type="image" className="w-1/2 bg-cream py-[18px] pl-[20px] rounded-xl mb-[26px] border border-green text-[20px] text-green mb-[20px]"></input>
                        <Icon icon="ri:image-add-fill" className='h-[70px] w-[70px]' />
                    </div>

                    <p className="mb-[12px]">Nama Usaha</p>
