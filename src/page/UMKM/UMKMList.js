...
const UMKMList = () =>{
    ...
    return(
        <div className="flex flex-col">
            ...
            {/* List */}
            <section id="list" className={'w-screen bg-[url(http://localhost:3000/background-hijau.png)] bg-cover bg-center items-center flex flex-wrap gap-[35px] justify-center py-[90px]'}>
                <CardStyle/>
                <CardStyle/>
                <CardStyle/>
                <CardStyle/>
