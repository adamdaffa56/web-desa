        ...
        <div className="flex flex-col">
            ...
            <section id="judul" className={'w-screen h-fit bg-[url(http://localhost:3000/background-hijau.png)] bg-cover bg-center flex flex-col py-[90px] px-[60px]'}>
                <div className="mb-[30px]">
                    <h2 className="text-[44px] font-semibold font-poppins text-cream text-left">Judul Informasi</h2>
                    <p className="text-[20px] font-regular font-poppins text-cream text-left">Tanggal Kegiatan : 20 July 2023</p>
                </div>
